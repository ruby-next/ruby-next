...
# JRuby added #import_methods in 9.4, but some specs fail.
# Ruby 3.2+ does not have Refinement#include
if !defined?(TruffleRuby) &&
   RubyNext.current_ruby_version < "3.2.0" &&
   (!defined?(JRUBY_VERSION) || RubyNext.current_ruby_version < "3.1.0")
   !RubyNext::Language.ast?
